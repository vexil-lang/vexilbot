...
func New(deps Deps) *Server {
	...
	s.mux.HandleFunc("GET /releases/status", s.handleReleaseStatus)
	s.mux.HandleFunc("POST /releases/workspace", s.handleWorkspaceRelease)
	s.mux.HandleFunc("POST /releases/single", s.handleSingleRelease)
